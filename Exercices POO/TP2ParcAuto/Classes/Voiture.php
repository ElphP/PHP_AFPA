    ...
    public function rouler(float $volume) { 
       ...
       if($carburant==0)  {
        ...
        function afficherInfos()  {
            echo "Voiture: ".$this->marque."-".$this->modele. ". Il reste ".$this->moteur->getVolumereservoir()." L dans le réservoir!<br>";
        }
        ...
        function afficherConsoTotale()  {
            echo "La voiture a consommé " .$this->moteur->getConsoTotale() . " L.<br>";
        }

        function afficherPleins_Reste()  {
            echo "Nombre total de litres versés: ".$this->moteur->getVolumeTotal(). " L, reste ".$this->moteur->getVolumereservoir(). " L.<br>";
        }
